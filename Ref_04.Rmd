...
Description
map panes can be created by supplying a name and a zIndex to control layer ordering. We recommend
a zIndex value between 400 (the default overlay pane) and 500 (the default shadow pane).
...
top of polygons. If two layers are provided to the same pane, overlay will be determined by order
of adding. See ### Examples below. See http://www.leafletjs.com/reference-1.3.0.html#

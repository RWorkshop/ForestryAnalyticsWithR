...
(the default) is appropriate for continuous data, "ngb" - nearest neighbor - is appropriate
...
raster package’s projectRaster function. This can be a time-consuming operation for even moderately
sized rasters. Upgrading the raster package to 2.4 or later will provide a large speedup versus
previous versions. If you are repeatedly adding a particular raster to your Leaflet maps, you can
